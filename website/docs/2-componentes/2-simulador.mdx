...
Para saber o que são e o que fazem os **registradores** descritos pelo simulador, consulte a [seção referente a estes na página do processador](/docs/componentes/processador/#registradores).
