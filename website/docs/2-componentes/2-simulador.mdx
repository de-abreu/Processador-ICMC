...
Os simuladores necessitam de um par de arquivos `.mif` para operarem sobre: o primeiro referente ao jogo － e gerado pelo [montador](/docs/componentes/montador) － e o segundo ao [charmap](/docs/guias/charmaps) correspondente, respectivamente. Para o simulador original, estes podem ser repassados conforme o comando
...
Para saber o que são e o que fazem os **registradores** descritos pelo simulador, consulte a seção referente a estes na página do [processador](/docs/componentes/processador).
